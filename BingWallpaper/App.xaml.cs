...
namespace BingWallpaper
{
    public partial class App : Application
    {
        ...
        {            
            try
            {
                BugSenseHandler.Instance.InitAndStartSession(new ExceptionManager(Current), RootFrame, "7302682c");
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            {
                viewModelLocator.MainViewModel.Load();
            }
        }
        ...
        {
            GoogleAnalytics.EasyTracker.GetTracker().SendException(e.ExceptionObject.StackTrace, false);
            if (Debugger.IsAttached)
            {
        ...
        private async void App_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            try
            {
                ...
                {
                    new CrashExtraData("Daily Wallpapers", e.ExceptionObject.Message),
                    new CrashExtraData("Daily Wallpapers", e.ExceptionObject.StackTrace),
                };
